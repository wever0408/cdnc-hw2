...
WebUI.click(findTestObject('1612585/07_AddTriggerMention/Page_Town Square - minus Mattermost/button_Notifications'))

WebUI.click(findTestObject('1612585/07_AddTriggerMention/Page_Town Square - minus Mattermost/span_Edit'))

WebUI.setText(findTestObject('1612585/07_AddTriggerMention/Page_Town Square - minus Mattermost/input_Other non-case sensitive words separa_48b795'), 
    trigger_name)

WebUI.click(findTestObject('1612585/07_AddTriggerMention/Page_Town Square - minus Mattermost/span_Save'))
